      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mb-20 relative">
          ...
          <OptionCard
            ...
            description="watch some exercise videos for better understanding of the exercises."
          ...
          <OptionCard
            ...
            title="Virtual Coach"
            description="Reach out to our AI coach for personalized advice and guidance."
